package com.andan.contohlocaldb.adapter

import android.view.LayoutInflater
import android.view.View
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.andan.contohlocaldb.R
import com.andan.contohlocaldb.databinding.ListNoteBinding
...
class NoteAdapter(private val onItemClickCallback: OnItemClickCallback) :
    ...
    inner class NoteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val binding = ListNoteBinding.bind(itemView)
        fun bind(note: Note) {
